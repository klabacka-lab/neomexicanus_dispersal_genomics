...
#MERGE FASTAS
mamba activate python
python strict_merge_fastas.py \
    "$WORKDIR/strict_filters/phylogeny/host-SNPs.min4.fasta" \
    "$WORKDIR/strict_filters/phylogeny/graft-SNPs.min4.fasta" \
    "$WORKDIR/strict_filters/phylogeny/strict-merged-SNPs.fasta"